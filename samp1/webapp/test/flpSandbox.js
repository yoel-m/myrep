		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testsamplecomsamp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testsamplecomsamp1-display": {
								"semanticObject": "testsamplecomsamp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.sample.com.samp1",
									"url": sap.ui.require.toUrl("test/sample/com/samp1")
								}
							}
						}
					}
